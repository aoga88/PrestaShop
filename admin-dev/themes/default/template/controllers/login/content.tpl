...
<div id="login-panel">
	<div id="login-header">
		<h1 class="text-center">
			<img id="logo" src="{$img_dir}prestashop@2x.png" height="24px" alt="Kadoo.mx" />
		</h1>
	...
	<div id="login-footer">
		<p class="text-center text-muted">
			<a href="http://www.kadoo.mx/" onclick="return !window.open(this.href);">
				&copy; Kadoo&#8482; 2017-{$smarty.now|date_format:"%Y"} - Derechos Reservados
			</a>
		</p>
		<p class="text-center">
			<a class="link-social link-twitter _blank" href="https://twitter.com/kadoo_mx" title="Twitter">
				<i class="icon-twitter"></i>
			</a>
			<a class="link-social link-facebook _blank" href="https://www.facebook.com/kadoomx" title="Facebook">
